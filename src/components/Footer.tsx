...
export default function Footer() {
    return (
        <footer className="relative bg-gradient-to-br from-[#2d452e] via-[#2d452e] to-[#1a2b1c] text-white pt-16 pb-8 overflow-hidden border-t border-white/10">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-0">
                    ...
                    <div className="relative md:pl-12 lg:px-10">
                        <h3 className="text-xs font-bold uppercase tracking-widest text-[#F6CA73] mb-8 flex items-center gap-2">
