...
export default function Hero() {
    return (
        <section className="relative h-[65vh] sm:h-[80vh] flex items-center justify-center overflow-hidden bg-[#2d452e]">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-6xl mx-auto px-10 sm:px-16 lg:px-24">
                <div className="flex flex-col items-center">
                    <Image
                        ...
                        className="w-auto h-24 sm:h-32 md:h-40 lg:h-48 xl:h-56 object-contain drop-shadow-[0_15px_40px_rgba(0,0,0,0.5)] translate-y-10 translate-x-6"
                        priority
                        quality={90}
                    />
                </div>
