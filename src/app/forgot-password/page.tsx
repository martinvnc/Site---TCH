            ...
            <div className="w-full max-w-xl relative bg-white p-12 md:p-16 rounded-[40px] border border-[#4c7650]/10 shadow-[0_20px_50px_rgba(76,118,80,0.08)]">
                ...
                <div className="text-center mb-10">
                    ...
                    {!success ? (
                        <>
                            ...
                            <h2 className="text-4xl font-extrabold tracking-tight text-[#2d452e]">Mot de passe oublié ?</h2>
                            <p className="mt-4 text-[#4c7650] font-medium">Pas de problème ! Entrez votre email et nous vous enverrons un lien de réinitialisation.</p>
                        </>
                    ) : (
                        <>
                            ...
                            <h2 className="text-4xl font-extrabold tracking-tight text-[#2d452e]">Email envoyé ! 📧</h2>
                            <p className="mt-4 text-[#4c7650] font-medium">Vérifiez votre boîte mail. Nous vous avons envoyé un lien pour réinitialiser votre mot de passe.</p>
                        </>
                    )}
                </div>
                ...
                {!success ? (
                    ...
                    <div className="space-y-6">
                        <div className="bg-[#4c7650]/5 rounded-2xl p-6 border border-[#4c7650]/10">
                            <p className="text-sm text-[#4c7650] font-medium text-center leading-relaxed">
                                L'email a été envoyé à <strong className="text-[#2d452e]">{email}</strong>
                                <br />
